...
namespace Senparc.CO2NET.Cache.Redis
{
    public class RedisCacheLock : BaseCacheLock
    {
        ...
        private RedisBaseObjectCacheStrategy _redisStrategy;

        public RedisCacheLock(RedisBaseObjectCacheStrategy strategy, string resourceName, string key, int retryCount, TimeSpan retryDelay)
