...
namespace Senparc.CO2NET.Cache.Redis
{
    public class RedisCacheLock : BaseCacheLock
    {
        ...
        private IRedisObjectCacheStrategy _redisStrategy;

        public RedisCacheLock(IRedisObjectCacheStrategy strategy, string resourceName, string key, int retryCount, TimeSpan retryDelay)
